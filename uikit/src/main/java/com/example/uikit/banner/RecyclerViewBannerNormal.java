...
import com.example.uikit.banner.adapter.NormalRecyclerAdapter;

import java.util.List;

/**
 * Created by tj on 2017/12/19.
 */

public class RecyclerViewBannerNormal extends RecyclerViewBannerBase<LinearLayoutManager, NormalRecyclerAdapter> {

    public RecyclerViewBannerNormal(@NonNull Context context) {
        this(context, null);
    }

    public RecyclerViewBannerNormal(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewBannerNormal(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
